...
//    }
    ...
    private String selectedMovieName1;
    ...
    public void showFilmDetail(String selectedMovieName) throws ParseException {
        ...
        movie.getSchedules().forEach(schedule -> System.out.println(movie.getSchedules().indexOf(schedule) + ". " + schedule.getStartTime() + " \t | \t " + schedule.getEndTime()));
        System.out.println();
...
//                .seat(seat)
    ...
    public void updateMovie(String selectedMovieName) {
        // TODO : do update
        selectedMovieName1 = selectedMovieName;
    }
